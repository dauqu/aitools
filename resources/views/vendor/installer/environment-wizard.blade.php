...
<head>
    ...
    <!-- CSS files -->
    <link href="../../css/installer.min.css" rel="stylesheet" />
    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            ...
            <div class="text-center mb-4">
                <a href="#" class="navbar-brand navbar-brand-autodark"><img src="{{ url('installer/img/logo.png') }}"
                        height="36" alt=""></a>
                <div class="hr-text hr-text-center mb-0 mt-4 hr-text-spaceless">{{ __('Server Requirements') }}</div>
            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="purchase_code"
                                                    id="purchase_code" value="{{ old('purchase_code') }}"
                                        ...
                                        <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="environment" id="environment"
                                                    ...
                                                    <option value="local" {{ $server_name=="localhost" &&
                                                        $server_name=="127.0.0.1" && $url=="test" ? 'selected' : '' }}>
                                                        {{
                                                    ...
                                                    <option value="production" {{ $server_name !="localhost" &&
                                                        $server_name !="127.0.0.1" && $url !="test" ? 'selected' : ''
                                                        }}>
                                                        {{
                                        ...
                                        <div
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="database_hostname"
                                                    id="database_hostname" value="127.0.0.1"
                                                    value="{{ old('database_hostname') }}"
