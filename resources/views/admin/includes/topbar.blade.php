...
<header class="navbar navbar-expand-md navbar-light d-print-none">
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            {{-- Light / Dark Mode --}}
            <a href="{{ route('admin.change.theme', 'dark') }}" class="nav-link px-0 hide-theme-dark"
            ...
            <a href="{{ route('admin.change.theme', 'light') }}" class="nav-link px-0 hide-theme-light"
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="{{ route('admin.index.account') }}" class="dropdown-item">{{ __('Profile & account') }}</a>
