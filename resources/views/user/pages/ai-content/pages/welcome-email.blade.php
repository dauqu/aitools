        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">{{ __('Write personalized email to welcome the customer for joining your service / product.') }}</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Service / Product Name')
                                            }}</label>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Description of your service / product')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            maxlength="600"
                                            placeholder="{{ __('Eg: CAPSI Newsletter to keep you updated with new research') }}"
                                            required></textarea>
                                    </div>
                                </div>
