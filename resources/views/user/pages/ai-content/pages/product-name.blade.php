                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Product Description Details')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="400"
                                            placeholder="{{ __('Eg: Great Aesthetics, Usage ideal for office, education sectors, designing, basic gaming etc') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                {{-- Product keywords --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Keywords of your product')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            placeholder="{{ __('Eg: dell, wireless, mouse') }}"
                                            required></textarea>
                                        <small class="form-hint">{{ __('If using more than one keyword use ","
                                            (comma).') }}</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 50')}}" value="50" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control elect" name="results" id="results" required>
