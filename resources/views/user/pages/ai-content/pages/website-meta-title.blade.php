                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            maxlength="300" placeholder="{{ __('Eg: service, application, brands') }}"
                                            required></textarea>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 60')}}" value="60" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
