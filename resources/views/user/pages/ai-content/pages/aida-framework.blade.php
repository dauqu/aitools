        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">{{ __('The best-known marketing model for tracing the customer journey.') }}
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                <input type="hidden" class="form-control" name="type" id="type" value="aida-framework">
                                {{-- Tone --}}
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Company/Brand Name')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: Writer') }}" required></textarea>
                                    </div>
                                </div>
                                {{-- What Product/Services Do You Offer --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('What Products/Services Do You Offer')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            maxlength="600"
                                            placeholder="{{ __('Eg: Help generating ideas, organizing your thoughts, or crafting a compelling piece of writing.') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 150')}}" value="150" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
