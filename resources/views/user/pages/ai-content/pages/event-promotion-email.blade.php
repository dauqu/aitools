                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Event Name')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: Google I/O 2023') }}" required></textarea>
                                    </div>
                                </div>
                                {{-- Description of your event --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Description of your event')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            maxlength="600"
                                            placeholder="{{ __('Eg: Google I/O is an annual developer conference held by Google in Mountain View, California.') }}"
                                            required></textarea>
                                    </div>
                                </div>
