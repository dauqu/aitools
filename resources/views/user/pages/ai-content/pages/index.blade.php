                    ...
                    <div class="col-3 d-none d-md-block border-end">
                        <div class="card-body">
                            <div class="list-group list-group-transparent">
                                <a href="#all"
                                    class="list-group-item list-group-item-action d-flex align-items-center active" data-bs-toggle="tab" aria-selected="true" role="tab">{{ __('All') }}</a>
                                <a href="#blog" class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Blog') }}</a>
                                <a href="#content" class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Content') }}</a>
                                <a href="#website"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Website') }}</a>
                                <a href="#social"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Social Media') }}</a>
                                <a href="#email"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Email') }}</a>
                                <a href="#video"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Video') }}</a>
                                <a href="#review"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Review') }}</a>
                                <a href="#product"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Product / Startup') }}</a>
                                <a href="#others"
                                    class="list-group-item list-group-item-action d-flex align-items-center" data-bs-toggle="tab" aria-selected="false" role="tab">{{ __('Others') }}</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active show" id="all" role="tabpanel">
                                    <div class="row row-cards">
                                        ...
                                        {{-- Keyword generator by query --}}
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                {{-- Check --}}
                                                @if (isset(json_decode($active_plan->templates)->generate_by_website_url))
                                                    @if(json_decode($active_plan->templates)->generate_by_website_url == 1)
                                                    <div class="ribbon rounded bg-warning">
                                                        {{ __('New') }}
                                                    </div>
                                                    @else
                                                ...
                                                {{-- Check --}}
                                                @if (isset(json_decode($active_plan->templates)->generate_by_website_url))
                                                    <a class="{{ json_decode($active_plan->templates)->generate_by_website_url == 1 ? '' : 'open-premium' }}"
                                                        href="{{ json_decode($active_plan->templates)->generate_by_website_url == 1 ? route('user.ai.generate.by.website.url') : '#premiumModel' }}">
                                                        <div class="card-body">
                                                            <h3 class="card-title text-muted mt-4">{{ __('Generate by Website URL')}}</h3>
                                                            <p class="text-muted">{{ __('Generate mete title, meta description and keywords from a given website url.') }}</p>
                                                        </div>
                                                    </a>
                                                @else
                                                    <a class="open-premium"
                                                        href="#premiumModel">
                                                        <div class="card-body">
                                                            <h3 class="card-title text-muted mt-4">{{ __('Generate by Website URL')}}</h3>
                                                            <p class="text-muted">{{ __('Generate mete title, meta description and keywords from a given website url.') }}</p>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                {{-- Check --}}
                                                @if (isset(json_decode($active_plan->templates)->blog_outline))
                                                ...
                                                {{-- Check --}}
                                                @if (isset(json_decode($active_plan->templates)->blog_outline))
                                                    <a class="{{ json_decode($active_plan->templates)->blog_outline == 1 ? '' : 'open-premium' }}"
                                                        href="{{ json_decode($active_plan->templates)->blog_outline == 1 ? route('user.ai.blog.outline') : '#premiumModel' }}">
                                                        <div class="card-body">
                                                            <h3 class="card-title text-muted mt-4">{{ __('Blog Outline')}}</h3>
                                                            <p class="text-muted">{{ __('Generate blog outline from a given topic') }}</p>
                                                        </div>
                                                    </a>
                                                @else
                                                    <a class="open-premium"
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->blog_headline == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Blog Headline')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->blog_description == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Blog Description')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->blog_story_ideas == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Blog Story Ideas') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->article_content == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Article Content') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->paragraph == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Paragraph') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->summarization == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Summarization') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->product_name == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Product Name') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->product_description == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Product Description')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->startup_name == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Startup Name')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->service_review == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Service Review')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_titles == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Titles')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_tags == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Tags')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_outline == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Outline')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_intro == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Intro')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_ideas == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Ideas')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_short_script == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Short Script') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->write_for_me == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Write for me')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->website_meta_description == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Website Meta Description')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->website_meta_keywords == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Website Meta Keywords') }}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->website_meta_title == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Website Meta Title')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->event_promotion_email == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Event Promotion Email')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->twitter_writer == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Twitter Writer')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->presentation_content == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('AI Presentation Content')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->ask_question == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Ask a Question')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->landing_page == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Landing Page')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->google_ads == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Google Ads')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->aida == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('AIDA framework')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->product_review == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Product Review')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->welcome_email == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Welcome Email')}}</h3>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->youtube_video_description == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('YouTube Video Description')}}</h3>
                                                        <p class="text-muted">{{ __('Create your video content with the help of AI') }}</p>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <a class="{{ json_decode($active_plan->templates)->custom_prompt == 1 ? '' : 'open-premium' }}"
                                                    ...
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Custom Prompt')}}</h3>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                @endif
                                                <a class="{{ json_decode($active_plan->templates)->article_content == 1 ? '' : 'open-premium' }}"
                                                    href="{{ json_decode($active_plan->templates)->article_content == 1 ? route('user.ai.blog.story.ideas') : '#premiumModel' }}">
                                                    <div class="card-body">
                                                        <h3 class="card-title text-muted mt-4">{{ __('Article Content') }}</h3>
                                                        <p class="text-muted">{{ __('Create appealing and awe-inspiring content for the viewers.') }}</p>
                                                    </div>
