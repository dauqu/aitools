        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Startup Name Creator') }}
                    </h2>
                    <p class="text-muted">{{ __('Generate a short, brandable business / startup name using artificial intelligence')
                        }}</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Business Model')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="400"
                                            placeholder="{{ __('Eg: Ecommerce or electronic commerce is the trading of goods and services on the internet.') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                {{-- Product keywords --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Keywords of your business')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            placeholder="{{ __('Eg: ecommerce, online, eshop') }}" required></textarea>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 20')}}" value="10" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
