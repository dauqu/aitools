                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Channel Name')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: Mr. India') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                {{-- Video Title --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Video Title')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2" maxlength="120"
                                            placeholder="{{ __("Eg: 'Discover India's Top Tourist Destinations - An Unforgettable Journey!'") }}"
                                            required></textarea>
                                    </div>
                                </div>
