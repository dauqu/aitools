                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" class="form-control" name="type" id="type"
                                            value="blog-story-ideas">
                                            <select class="tomselected form-select " name="lang" id="langs" required>
                                                @include('user.pages.ai-content.includes.lang')
                                            </select>
                                    </div>
                                </div>
                                {{-- What type of blog post do you want to create? --}}
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('What type of blog post do you want to create?')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="3"
                                            placeholder="{{ __('Eg: Latest technology') }}" required></textarea>
                                    </div>
                                </div>
