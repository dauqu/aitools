                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Title of your blog post')
                                            }}</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('Eg: Latest technology') }}" required>
                                    </div>
                                </div>
                                {{-- Blog keywords --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Keywords of your blog post')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            placeholder="{{ __('Eg: latest technology, technology, new technology') }}" required></textarea>
