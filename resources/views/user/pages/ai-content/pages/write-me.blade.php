        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">{{ __('Continue and complete my unfinished paragraph.')
                        }}</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('What would you like to expand on?')
                                            }}</label>
                                        <textarea class="form-control" data-bs-toggle="autosize" name="name" id="name"
                                            rows="2" maxlength="1000"
                                            placeholder="{{ __('Eg: On the first day of her trip, Diane visited the Golden Gate') }}"
                                            required
