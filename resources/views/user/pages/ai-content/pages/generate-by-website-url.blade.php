        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Generate by Website URL') }}
                    </h2>
                    <p class="text-muted">{{ __('Generate mete title, meta description and keywords from a given website
                        url.') }}</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Country')
                                            }}</label>
                                        <input type="hidden" class="form-control" name="type" id="type"
                                            value="generate_by_website_url">
                                        <select class="tomselected form-select " name="lang" id="langs" required>
                                            @include('user.pages.ai-content.includes.countries')
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Enter url of your website')
                                            }}</label>
                                        <input type="url" class="form-control" name="name" id="name"
                                            placeholder="{{ __('Eg: http://domain.com') }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
