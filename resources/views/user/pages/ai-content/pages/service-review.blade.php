        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Service Review Creator') }}
                    </h2>
                    <p class="text-muted">{{ __('Write Service Reviews based on the provider name and service name')
                        }}</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Provider Name')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="400"
                                            placeholder="{{ __('Eg: Ola Cabs') }}" required></textarea>
                                    </div>
                                </div>
                                {{-- Service Name --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Service Name')
                                            }}</label>
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            placeholder="{{ __('Eg: Rental Car') }}"
                                            required></textarea>
                                    </div>
                                </div>
