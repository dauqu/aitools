                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('What topic would you like to write about?')
                                            }}</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('Eg: Horror Story')}}" maxlength="110" required>
                                    </div>
                                </div>
                                {{-- What keywords are you using for this article? --}}
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('What keywords are you using for this article?')
                                            }}</label>
                                        <input type="text" class="form-control" name="keywords" id="keywords"
                                            placeholder="{{ __('Eg: Horror, story, novel')}}" maxlength="70" required>
