                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Blog Topic')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="3"
                                            placeholder="{{ __('Eg: How to use AI for blog writing?') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            ...
                                            max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}"
                                            required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
