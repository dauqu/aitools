        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">{{ __('A tool that represents the most important or relevant information in the original content.') }}</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('What would you like to summarize?')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="3" maxlength="512"
                                            placeholder="{{ __('Eg: Your content') }}"
                                            required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 12')}}" value="12" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
