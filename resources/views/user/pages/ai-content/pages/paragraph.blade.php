                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Description of Paragraph')
                                            }}</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('Eg: Best tourist destination india or UAE?')}}" maxlength="200" required>
                                    </div>
                                </div>
                                {{-- Keywords you use in the paragraph --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Keywords you use in the paragraph')
                                            }}</label>
                                        <input type="text" class="form-control" name="keywords" id="keywords"
                                            placeholder="{{ __('Eg: india, uae, tourist destination') }}" maxlength="150" required>
