        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Product Description Creator') }}
                    </h2>
                    <p class="text-muted">{{ __('That enables you to create beautiful and effective product descriptions that sell')
                        }}</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('Product Name Details')
                                            }}</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('Eg: Dell wireless mouse') }}" maxlength="256" required>
                                    </div>
                                </div>
                                {{-- Product keywords --}}
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            placeholder="{{ __('Eg: dell, wireless, mouse') }}" required></textarea>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 250')}}" value="250" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
