        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Youtube Shorts Script Intro') }}
                    </h2>
                    <p class="text-muted">{{ __('Create the perfect script for your next viral Youtube Shorts.')
                        }}</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: How to create youtube shorts?') }}"
                                            required></textarea>
                                    </div>
                                </div>
