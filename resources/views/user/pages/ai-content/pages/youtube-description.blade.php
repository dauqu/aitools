        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Youtube Video Description') }}
                    </h2>
                    <p class="text-muted">{{ __('Describe your videos with your information that will reach its viewers.')
                        }}</p>
                </div>
            </div>
        </div>
                    ...
                    <form action="javascript:void(0)" id="saveForm" method="POST" class="card">
                        ...
                        <div class="card-body">
                            <div class="row row-cards">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label required">{{ __('What is your video about?')
                                            }}</label>
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: How To Start YouTube Channel | English') }}" required></textarea>
                                    </div>
                                </div>
