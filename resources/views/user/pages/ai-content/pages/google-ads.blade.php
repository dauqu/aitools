        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted">{{ __('Generate Google Ads descriptions in within seconds') }}
                    </p>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="name" id="name" rows="2" maxlength="120"
                                            placeholder="{{ __('Eg: AI Tools') }}" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="keywords" id="keywords" rows="2"
                                            maxlength="600" placeholder="{{ __('Eg: We are a development platform') }}"
                                            required></textarea>
                                    </div>
                                </div>
