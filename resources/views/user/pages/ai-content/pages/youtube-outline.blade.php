        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Youtube Video Outline') }}
                    </h2>
                    <p class="text-muted">{{ __('Tell me more about the your video')
                        }}</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_length" id="max_length"
                                            placeholder="{{ __('Eg: 10')}}" value="10" max="{{ $config[30]->config_value == null ? '600' : $config[30]->config_value }}" required>
                                    </div>
                                </div>
                                {{-- No. Of Results --}}
                                <div class="col-sm-6 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-select" name="results" id="results" required>
                                            ...
                                            <option value="4" selected>{{ __('4') }}</option>
