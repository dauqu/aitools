            ...
            <div class="row row-cards row-deck mb-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border border-muted rounded">
                        <a href="{{ route('user.new.ai.content') }}" class="text-muted">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <span class="badge bg-red text-capitalize">{{ str_replace('-', ' ', $content->type)
                                    }}</span>
                                {{-- Actions --}}
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="right"
                                                title="{{ __('View') }}"
                                                href="{{ route('user.view.ai.content', $content->generate_id) }}">{{
                                                __('View')}}</a>
                                            <a class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="right"
                                                title="{{ __('Edit') }}"
                                                href="{{ route('user.edit.ai.content', $content->generate_id) }}">{{
                                                __('Edit')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h3 class="card-title text-uppercase my-1">{{ mb_strimwidth($content->name, 0, 32, "...") }}</h3>
