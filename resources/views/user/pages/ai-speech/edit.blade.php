            ...
            <div class="row row-cards">
                <div class="col-lg-12 col-md-12 px-3">
                    <div class="card">
                            ...
                            <div class="col-auto ms-auto d-print-none">
                                <div class="btn-list">
                                    <div class="col-auto ms-auto d-print-none">
                                        <span class="dropdown">
                                            {{-- Export Docs --}}
                                            <a href="{{ route('user.export.docs.speech.to.text', $content->generate_id) }}"
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.update.ai.speech.to.text') }}" id="saveForm" method="POST">
                                @csrf
                                ...
                                <div class="card-footer text-end">
                                    <div class="d-flex">
                                        <a href="{{ route('user.all.ai.speech.to.text') }}" class="btn btn-link">{{
                                            __('Cancel')
                                            }}</a>
                                        <a href="{{ route('user.view.ai.speech.to.text', $content->generate_id) }}"
                                            class="btn btn-dark">{{
                                            __('View')
                                            }}</a>
