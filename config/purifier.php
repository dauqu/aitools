...
return [
    ...
    'settings'      => [
        'default' => [
            ...
            'HTML.Allowed'             => 'iframe[src|width|height|class|frameborder],div[style|class],p[style|class],span[style|class],b,strong,i,em,u,a[href|title|style|class],ul[style|class],ol[style|class],li[style|class],br,img[style|width|height|alt|src|class],h1[style|class],h2[style|class],h3[style|class],h4[style|class],h5[style|class],h6[style|class],blockquote,pre,font[color],table[style|class],td[style|class],tr[style|class],tbody[style|class],i[style|class]',
