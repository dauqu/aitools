...
class SettingController extends Controller
{
    ...
    public function changeWebsiteSettings(Request $request)
    {
        ...
        if (isset($request->site_logo)) {
            ...
            // Update details
            Setting::where('id', '1')->update([
                'analytics_id' => $request->google_analytics_id, 'adsense_code' => $request->adsense_code,
    ...
    {
        // Page redirect
        return redirect()->route('admin.settings')->with('failed', trans('You can change the respective values directly from .env file.'));
    }
